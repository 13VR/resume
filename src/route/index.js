...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'Ukrain, Kyiv city',
}

var footer = {
  social: {
    email: {
      text: 'rad4enko.vitaliy@gmail.com',
      href: 'mailto:rad4enko.vitaliy@gmail.com',
    },
    phone: {
      text: '+380634899813',
      href: 'tel:+380634899813',
    },
    linkedin: {
      text: 'LinkedIn',
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        ...
        {
          name: 'Сертифікат про закінчення курсів',
          id: '789',
        },
      ],
    },
          ...
          projects: [
            {
              ...
              about:
                'Створення свого персонального резюме з використання основної телнологоїї HeandleBars',
              stackAmount: 3,
              stacks: [
                {
                  name: 'React.js',
              ...
              awards: [
                {
                  name: 'Знайомство з HeandleBars',
                },
                {
                  name: 'Практичні навички з написання коду',
                },
              ],
            },
          ],
